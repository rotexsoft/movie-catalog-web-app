...
return function(array $appSettings): ContainerInterface {
    ...
    $container[ContainerKeys::VESPULA_AUTH] = function (ContainerInterface $c) {
        ...
        $pdo = new \PDO(
            $c[ContainerKeys::APP_SETTINGS][AppSettingsKeys::DB_DSN],
            $c[ContainerKeys::APP_SETTINGS][AppSettingsKeys::DB_USER],
            $c[ContainerKeys::APP_SETTINGS][AppSettingsKeys::DB_PASS], 
            [
