...
/**
 * 
 * Description of HttpNotAllowedNotFoundServerErrorHandler goes here
 *
 * 
 */
class HttpNotAllowedNotFoundServerErrorHandler extends \MovieCatalog\Controllers\MovieCatalogBase
{   
    /**
     * 
     ...
     * @var string
     */
    protected $login_success_redirect_controller = 'http-not-allowed-not-found-server-error-handler';
